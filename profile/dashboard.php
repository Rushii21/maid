...
if($client != null){
  ...
  /* /.nbrseances */
	...
	$MNSQL = "SELECT count(*) FROM reservation WHERE idclient = ".$idclient." AND typemenage LIKE 'Deep cleaning'";
	...
	if($MN->num_rows >= 0){
	  ...
	  $MN100 = ($nbrreservations != 0) ? ($nbrMN / $nbrreservations) * 100 : 0;
	...
	/* /.menage normale */
		...
		$GMSQL = "SELECT count(*) FROM reservation WHERE idclient = ".$idclient." AND typemenage LIKE 'House Cleaning'";
		...
		if($GM->num_rows >= 0){
		  ...
		  $GM100 = ($nbrreservations != 0) ? ($nbrGM / $nbrreservations) * 100 : 0;
	...
	$NVSQL = "SELECT count(*) FROM reservation WHERE idclient = ".$idclient." AND typemenage LIKE 'Babysitting'";
	...
	if($NV->num_rows >= 0){
	  ...
	  $NV100 = $nbrreservations != 0 ? ($nbrNV / $nbrreservations) * 100 : 0;


	/* /.Nettoyage Vitres */
		/* Nettoyage Des Bureaux */

		$NDBSQL = "SELECT count(*) FROM reservation WHERE idclient = ".$idclient." AND typemenage LIKE 'Shifting'";
		...
		if($GM->num_rows >= 0){
		  ...
		  $NDB100 = $nbrreservations != 0 ? ($nbrNDB / $nbrreservations) * 100 : 0;
		...
		$NADSQL = "SELECT count(*) FROM reservation WHERE idclient = ".$idclient." AND typemenage LIKE 'Pre-Move Cleaning'";
		...
		if($NAD->num_rows >= 0){
		  ...
		  $NAD100 = $nbrreservations != 0 ? ($nbrNAD / $nbrreservations) * 100 : 0;
									...
									<div class="col-sm-12 infobox-container">
										...
										<div class="infobox infobox-orange2">
											...
											<div class="infobox-data">
												...
												<div class="infobox-content">Bookings</div>
											</div>
										</div>
									</div>
...
<![endif]-->
		...
		<script type="text/javascript">
			jQuery(function($) {
			  ...
			  var data = [
				{ label: "Deep Cleaning",  data: <?php echo $MN100;?>, color: "#68BC31"},
				{ label: "House Cleaning",  data: <?php echo $GM100;?>, color: "#2091CF"},
				{ label: "Shifting",  data: <?php echo $NDB100;?>, color: "#AF4E96"},
				{ label: "BabySitting",  data: <?php echo $NV100;?>, color: "#DA5430"},
				{ label: "Pre-Move Cleaning",  data: <?php echo $NAD100;?>, color: "#FEE074"}
			  ]
