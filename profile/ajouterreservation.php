                        ...
                        <div class="row">
                            <form method="post">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="typemenage">Type of Cleaning</label>
                                        <br />
                                        <select class="chosen-select form-control" id="typemenage" name="typemenage" data-placeholder="Type of Cleaning...">
                                            <option value="">  </option>
                                            <option value="House Cleaning">House Cleaning</option>
                                            <option value="Babysitting">Babysitting</option>
                                            <option value="Shifting">Shifting</option>
                                            <!-- <option value="Grand Ménage">Deep Cleaning</option> -->
                                            <option value="Nettoyage Avant Déménagement">Pre-Move Cleaning</option>
                                        </select>
                                    </div>
                                    <!-- #section:plugins/input.chosen -->
                                    <div class="col-sm-6">
                                        ...
                                        <br />
                                        <select class="chosen-select form-control" id="duree" name="duree" data-placeholder="Cleaning Duration...">
                                            <option value="">  </option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <br />
                                        <select class="chosen-select form-control" id="ville" name="ville" data-placeholder="City...">
                                            <option value="">  </option>
                                    ...
                                    <!-- #section:plugins/input.chosen -->
                                    <div class="col-sm-6">
                                        <label for="nbrpersonne">Number of People</label>
                                        <br />
                                        <select class="chosen-select form-control" id="nbrpersonne" name="nbrpersonne" data-placeholder="Number of People...">
                                            <option value="">  </option>
                                ...
                                <div class="row">
                                    ...
                                    <!-- #section:plugins/input.chosen -->
                                    <div class="col-sm-6">
                                        <label for="frequence">Session Frequency</label>
                                        <br />
                                        <select class="chosen-select form-control" id="frequence" name="frequence" data-placeholder="Session Frequency...">
                                            <option value="">  </option>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                ...
                                                <span class="lbl"> Products and Tools <span style="font-size: 12px; color: green;">(+ 100 DH)</span></span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
