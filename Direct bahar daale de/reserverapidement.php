        ...
        <form action="" method="post" enctype="multipart/form-data">
            <div class="defaultdiv">
                <div class="select flex">
                    ...
                    <select name="typemenage" id="typemenage">
                        <option value="" hidden disabled selected>Type of Cleaning...</option>
                        <option value="Menage Normale">Regular Cleaning</option>
                        <option value="Nettoyage Des Bureaux">Office Cleaning</option>
                        <option value="Nettoyage Vitres">Window Cleaning</option>
                        <option value="Grand Ménage">Deep Cleaning</option>
                        <option value="Nettoyage Avant Déménagement">Move-out Cleaning</option>
                    </select>
                </div>
                <div class="select flex">
                    <i class="fa fa-solid fa-clock"></i>
                    <select name="duree" id="duree">
                        <option value="" hidden disabled selected>Cleaning Duration...</option>
            ...
            <div class="defaultdiv">
                ...
                <div class="select flex">
                    ...
                    <select name="nbrpersonne" id="duree">
                        <option value="" hidden disabled selected>Number of People...</option>
            ...
            <div class="defaultdiv">
                ...
                <div class="select flex">
                    ...
                    <select name="frequence" id="frequence">
                        <option value="" hidden disabled selected>Session Frequency...</option>
                        <option value="fois">One Time</option>
            ...
            <div class="defaultdiv">
                ...
                <div class="defaultdiv">
                    ...
                    <label for="file"><p>Identity Card</p><i class="fa-solid fa-address-card"></i></label>
                </div>
            </div>
            <div class="defaultdiv">
            ...
            <div class=" input">
				 ...
				 <input type="text" name="autre" placeholder="Other...">
			</div>
            <div class="defaultdiv flex">
                ...
                <label for="produitsetoutils"> Products and Tools <span style="font-size: 12px; color: var(--color-primary);">(+ 100 DH)</span></label>
            </div>
            
            <div class="submit">
                <button onclick="window.location.href='index.php#Services'"  name="voiroffres" value="VOIREOFFRES">SEE OFFERS<i class="fa-solid fa-arrow-right"></i></button>
                <button  type="submit" name="reserverapidement" value="RESERVERRAPIDEMENT">BOOK NOW</button>
            </div>
        </form>
    </div>
